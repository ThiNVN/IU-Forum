...
const { registerUser, loginUser, verificationEmail, verifyCode, getUserProfile, getUserProfilePost, addNewPost, getAllCommentOfPost, addNewComment, updateUserProfile, get10LastedActivity, checkUserCookie, logoutUser } = require('../controllers/homeController');
